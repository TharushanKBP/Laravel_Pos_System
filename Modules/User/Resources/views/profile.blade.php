                ...
                <div class="card-body">
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @php
                            $profileImage = auth()->user()->getFirstMediaUrl('avatars', 'thumb') ?: asset('images/default-profile.png');
                            @endphp
                            <img style="width: 100px;height: 100px;" class="d-block mx-auto img-thumbnail img-fluid rounded-circle mb-2" src="{{ $profileImage }}" alt="Profile Image">
